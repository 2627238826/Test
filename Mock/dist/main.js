...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mockjs__ = __webpack_require__(2);
...
var Random = __WEBPACK_IMPORTED_MODULE_1_mockjs___default.a.Random;
// 使用 Mock
var data = __WEBPACK_IMPORTED_MODULE_1_mockjs___default.a.mock({
    'list|1-10': [{
        'id|+1': 1,
        'name':'张三111111'
    }]
...
__WEBPACK_IMPORTED_MODULE_1_mockjs___default.a.mock('http://cn', {
    'name'     : '@name',
    'age|1-100': 100,
    'color'    : '@color',
});
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default.a('<pre>').text(JSON.stringify(data, null, 4))
    .appendTo('body')
